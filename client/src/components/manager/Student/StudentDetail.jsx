  ...
  return (
    <div className={cx("studentDetailWrapper")}>
      ...
      <div className={cx("row")}>
        ...
        <span className={cx("value")}>{studentUpdate.lastUpdate || "N/A"}</span>
      </div>
      ...
      <div className={cx("row")}>
        ...
        {isEditing ? (
          ...
          <span className={cx("value")}>{studentUpdate.fullName}</span>
        )}
      </div>
      ...
      <div className={cx("row")}>
        ...
        {isEditing ? (
          ...
          <span className={cx("value")}>{studentUpdate.className}</span>
        )}
      </div>

      <div className={cx("row")}>
        <span className={cx("label")}>Parent Name:</span>
        <span className={cx("value")}>{studentUpdate.parentName}</span>
      </div>

      <div className={cx("row")}>
        <span className={cx("label")}>Parent Phone:</span>
        <span className={cx("value")}>{studentUpdate.parentPhone}</span>
      </div>
      ...
      <div className={cx("row")}>
        ...
        {isEditing ? (
          ...
          >
            ...
            <option value="Ngừng tham gia">Ngừng tham gia</option>
          </select>
        ) : (
      ...
      <div className={cx("row")}>
        ...
        {isEditing ? (
          <input
            type="text"
            name="assignedBus"
            value={studentUpdate.assignedBus || ""}
            onChange={handleChange}
          />
        ) : (
          <span className={cx("value")}>
            {studentUpdate.assignedBus || "N/A"}
          </span>
        )}
      </div>
