    ...
    const fetchRoutes = async () => {
      ...
      for (const bus of buses) {
        ...
        try {
          ...
          console.error(`Error fetching route for ${bus.routeNumber}:`, err);
        }
      }
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      ...
      try {
        ...
        const resParents = await UserController.fetchUserByRole("parent");
      ...
      <div className={cx("content")}>
        ...
        <div className={cx("right-block")}>
          <Routes>
            <Route
              path="/myschedule"
              element={<MyScheduleTab buses={buses} routes={routes} />}
            />
            ...
            <Route
              ...
              element={
                <span>
                  Chọn một xe bus trong Schedule để xem bản đồ theo dõi.
                </span>
              }
            />

            <Route path="/tracking/:id" element={<DriverTrackingWrapper />} />
              ...
              element={
                Object.keys(routes).length ? (
                  <StudentListTab
                    ...
                    route={
                      routes[
                        buses.find((b) => b.busStatus === "Đang chạy")
                          ?.routeNumber
                      ]
            ...
            <Route path="/report" element={<ReportTab buses={buses} />} />
          </Routes>
        </div>
      </div>
    </div>
